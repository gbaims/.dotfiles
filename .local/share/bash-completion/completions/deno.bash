_deno() {
    ...
    case "${cmd}" in
        deno)
            ...
            ;;
        deno__add)
            opts="-h -L -q -D --unstable --unstable-bare-node-builtins --unstable-byonm --unstable-sloppy-imports --unstable-broadcast-channel --unstable-cron --unstable-ffi --unstable-fs --unstable-http --unstable-kv --unstable-net --unstable-process --unstable-temporal --unstable-unsafe-proto --unstable-webgpu --unstable-worker-options --help --log-level --quiet --dev [packages]..."
        ...
        deno__cache)
            ...
            ;;
        deno__check)
            opts="-h -L -q -c -r --unstable --unstable-bare-node-builtins --unstable-byonm --unstable-sloppy-imports --unstable-broadcast-channel --unstable-cron --unstable-ffi --unstable-fs --unstable-http --unstable-kv --unstable-net --unstable-process --unstable-temporal --unstable-unsafe-proto --unstable-webgpu --unstable-worker-options --help --log-level --quiet --import-map --no-remote --no-npm --node-modules-dir --vendor --config --no-config --reload --lock --no-lock --cert --unsafely-ignore-certificate-errors --all --remote --doc --doc-only [file]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        deno__init)
            ...
            ;;
        deno__install)
            opts="-h -L -q -c -r -A -R -W -N -E -S -n -f -g -e -D --unstable --unstable-bare-node-builtins --unstable-byonm --unstable-sloppy-imports --unstable-broadcast-channel --unstable-cron --unstable-ffi --unstable-fs --unstable-http --unstable-kv --unstable-net --unstable-process --unstable-temporal --unstable-unsafe-proto --unstable-webgpu --unstable-worker-options --help --log-level --quiet --no-check --import-map --no-remote --no-npm --node-modules-dir --vendor --config --no-config --reload --lock --no-lock --cert --unsafely-ignore-certificate-errors --inspect --inspect-brk --inspect-wait --frozen --cached-only --location --v8-flags --seed --enable-testing-features-do-not-use --strace-ops --allow-all --allow-read --deny-read --allow-write --deny-write --allow-net --deny-net --allow-env --deny-env --allow-sys --deny-sys --allow-run --deny-run --allow-ffi --deny-ffi --allow-hrtime --deny-hrtime --no-prompt --check --allow-scripts --name --root --force --global --entrypoint --env-file --dev [cmd]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
        ...
        deno__remove)
            ...
            ;;
        deno__repl)
            opts="-h -L -q -c -r -A -R -W -N -E -S --unstable --unstable-bare-node-builtins --unstable-byonm --unstable-sloppy-imports --unstable-broadcast-channel --unstable-cron --unstable-ffi --unstable-fs --unstable-http --unstable-kv --unstable-net --unstable-process --unstable-temporal --unstable-unsafe-proto --unstable-webgpu --unstable-worker-options --env-file --help --log-level --quiet --no-check --import-map --no-remote --no-npm --node-modules-dir --vendor --config --no-config --reload --lock --no-lock --cert --unsafely-ignore-certificate-errors --allow-all --allow-read --deny-read --allow-write --deny-write --allow-net --deny-net --allow-env --deny-env --allow-sys --deny-sys --allow-run --deny-run --allow-ffi --deny-ffi --allow-hrtime --deny-hrtime --no-prompt --inspect --inspect-brk --inspect-wait --frozen --cached-only --location --v8-flags --seed --enable-testing-features-do-not-use --strace-ops --check --eval-file --eval [ARGS]..."
            if [[ ${cur} == -* || ${COMP_CWORD} -eq 2 ]] ; then
                COMPREPLY=( $(compgen -W "${opts}" -- "${cur}") )
                return 0
            fi
